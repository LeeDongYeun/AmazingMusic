...
namespace UserInterface_AM
{
    public partial class Edit : Form
    {
        ...
        {
            adjust_tempo(tempo, label6.Text, output_file);
            Close();
        ...
        private void textBox2_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    last_time = int.Parse(textBox2.Text);
                }
            }
            catch
            {
        ...
        public void cut_file(int start_time, int last_time, string input_file, string output_file)
        {
        ...
        {
            cut_file(start_time, last_time, label6.Text, output_file);
        }
        ...
        {
            adjust_pitch(pitch, label6.Text, output_file);
            Close();
        }
        public void adjust_pitch(double pitch, string input_file, string output_file)
        {
            ...
            string command = " -y -i " + input_file + " -filter:a \"asetrate = " + samplerate + "\" " + output_file;
            process.StartInfo.Arguments = command;
